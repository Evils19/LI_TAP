...
//Partea solida a obiectului
    ...
    switch (entity.direction){
case "sus": entity.coliziune.y-=entity.speed;break;
case "jos": entity.coliziune.y+=entity.speed;break;
case "stanga": entity.coliziune.x-=entity.speed;break;
case "dreapta": entity.coliziune.x+=entity.speed;break;
}
...
//Partea solida a obiectului
    ...
    public boolean  ColiziunePlayer(Entity entity){
        entity.Isplayer=false;
            ...
            switch (entity.direction){
                //Are scopul de a verifica coliziunea in directia in care se misca personajul
                case "sus": entity.coliziune.y-=entity.speed;break;
                case "jos": entity.coliziune.y+=entity.speed;break;
                case "stanga": entity.coliziune.x-=entity.speed;break;
                case "dreapta": entity.coliziune.x+=entity.speed;break;
